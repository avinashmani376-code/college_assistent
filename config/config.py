...
# GNews — primary key name used by news_service.py
GNEWS_API_KEY      = os.getenv("GNEWS_API_KEY", "")
# Legacy alias kept so existing .env / render.yaml entries still work
GNEWS_API          = os.getenv("GNEWS_API", "") or GNEWS_API_KEY
...
__all__ = [
    "GROQ_API_KEY", "OPEN_ROUTER_API", "WEATHER_API_KEY",
